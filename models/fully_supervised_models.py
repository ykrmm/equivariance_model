...
def main():
    ...
    parser.add_argument('--benchmark', default=False, type=bool, help="enable or disable backends.cudnn")
    parser.add_argument('--split', default=False, type=bool, help="Split the dataset")
    ...
    dataloader_train = torch.utils.data.DataLoader(train_dataset, batch_size=args.batch_size,num_workers=args.nw,pin_memory=args.pm,\
